...
import SentimentAnalyzer from "../../demos/Sentiment/Layout.tsx";
  ...
  react: {
    ...
    advancedComponents: [
      ...
      },
      {
        ...
        desc:
          "Gracefully handle rendering errors to prevent application crashes",
      ...
      },
      {
        ...
        desc:
          "Share global data (e.g., themes or user info) without prop drilling",
    ...
    experience: [
      ...
      },
      {
        ...
        years: "4+ years",
        focus: "Multi-product insurance quoting platforms and customer portals",
      },
      {
      ...
      },
      {
        ...
        years: "1+ year",
        focus: "IoT monitoring dashboards with real-time data visualization",
      },
      {
        company: "Freelance",
        years: "2+ years",
    ...
    experience: [
      {
        company: "Precedent",
        years: "2+ years",
        focus: "Type-safe architecture for legal document management systems",
      },
      {
        company: "CSAA Insurance Group",
        years: "4+ years",
        focus: "Implementing strict typing in insurance quoting platforms",
      },
      {
        company: "American Express",
        years: "1+ year",
    ...
    experience: [
      {
        ...
        years: "2+ years",
        focus:
          "Interactive dashboards for legal document management and insurance claims mediation applications",
      },
      {
        company: "CSAA Insurance Group",
        years: "4+ years",
        focus:
          "Data visualization for multi-product insurance quoting platforms, including charts and graphs for performance metrics",
      },
      {
        company: "American Express",
        years: "2+ years",
        focus:
          "Financial dashboards with real-time data visualization, including performance metrics and transaction trends",
      },
      {
        company: "Sierra Telecom",
        years: "1+ year",
        focus:
          "IoT monitoring dashboards with real-time data updates and geospatial visualization for device locations",
      },
      {
        company: "Freelance",
        years: "2+ years",
        focus:
          "Custom data visualization solutions for various clients, including e-commerce sales dashboards and portfolio performance charts",
      },
    ],
    implementation:
    ...
    experience: [
      {
        ...
        years: "2+ years",
        focus:
          "RTK Query for managing API calls and state in legal document management systems, including caching and synchronization of document data",
      },
      {
        company: "CSAA Insurance Group",
        years: "4+ years",
        focus:
          "Redux Toolkit for state management in multi-product insurance quoting platforms, including complex state normalization and middleware for side effects",
      },
      {
        company: "American Express",
        years: "2+ years",
  ...
  aws: {
    ...
    experience: [
      ...
      },
      {
        company: "CSAA Insurance Group",
        years: "4+ years",
        focus: "AWS services for protecting confidential customer information",
      },
      {
        company: "Freelance",
        years: "2+ years",
        focus: "Serverless architecture for scalable, cost-effective solutions",
      },
    ],
    implementation:
    ...
    experience: [
      {
        company: "Precedent",
        years: "2+ years",
        focus: "Legal document management interfaces with custom MUI themes",
      },
      {
        company: "CSAA Insurance Group",
        years: "4+ years",
        focus: "Building responsive insurance applications with MUI components",
      },
      {
        company: "American Express",
        years: "2+ years",
        focus: "Financial dashboards with customized Material UI components",
      },
    ],
    themeCodeSnippet,
  },
    ...
    experience: [
      {
        company: "Precedent",
        years: "1+ year",
        focus: "Data processing and automation for legal document analysis",
      },
      {
        company: "Freelance",
        years: "2+ years",
  ...
  websockets: {
    ...
    advancedComponents: [
      ...
      },
      {
        ...
        desc:
          "Working directly with browser WebSocket API for optimal performance",
        tags: ["native", "api", "performance"],
      },
      {
        name: "Real-time Chat",
        desc:
          "Multi-user chat applications with typing indicators and presence detection",
...
huggingface: {
    id: "huggingface",
    title: "HuggingFace AI Integration",
    logoSrc: "/hugging-face-logo.png", 
    description:
        "Integration with HuggingFace's powerful AI models for natural language processing and sentiment analysis through secure API communication.",
    bulletPoints: [
        "DistilBERT model integration",
        "Sentiment analysis implementation",
        "Deno/Oak API communication",
        "Redux Toolkit Query integration",
        "Real-time sentiment visualization",
        "Response error handling"
    ],
    path: "/skills/huggingface",
    advancedComponents: [
        {
            name: "AI Model Integration",
            desc: "Secure integration with HuggingFace's Inference API for natural language processing",
            tags: ["ai", "model", "integration"],
        },
        {
            name: "Sentiment Analysis",
            desc: "Text emotion detection using pre-trained NLP models with confidence scoring",
            tags: ["sentiment", "analysis", "nlp"],
        },
        {
            name: "Deno API Layer",
            desc: "Secure backend server for AI model communication with proper error handling",
            tags: ["deno", "api", "backend"],
        },
        {
            name: "RTK Query Implementation",
            desc: "Efficient data fetching and caching for API communication with optimistic updates",
            tags: ["rtk", "query", "caching"],
        },
        {
            name: "Interactive Visualization",
            desc: "Dynamic UI components for real-time sentiment feedback and representation",
            tags: ["visualization", "ui", "feedback"],
        },
        {
            name: "Type-Safe Communication",
            desc: "Strongly typed interfaces for API requests and responses with proper error handling",
            tags: ["typescript", "interfaces", "errors"],
        },
    ],
    experience: [
        {
            ...
            years: "2025",
            focus: "Creating a sentiment analysis demo using HuggingFace's AI models with Deno backend and React frontend",
        },
    ],
    implementation: `This portfolio features a real-time sentiment analysis implementation that communicates with HuggingFace's powerful DistilBERT model. The backend is built with Deno and Oak, providing a secure API layer that handles authentication and error management. The frontend uses Redux Toolkit Query for efficient data fetching and state management, with a responsive UI that visualizes sentiment scores through an intuitive meter display. The implementation demonstrates modern patterns for AI integration in web applications with proper TypeScript typing throughout.`,
