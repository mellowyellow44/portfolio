...
const Navbar = () => {
  ...
  // Navigation items
  const navItems = [
    { name: "Tech Skills", icon: <PersonIcon />, path: "/skills" },
    { name: "Tech Resume", icon: <ArticleIcon />, path: "/resume" },
    { name: "Tech Demos", icon: <PlayArrowIcon />, path: "/demos" },
    { name: "Maritime Profile", icon: <Anchor />, path: "/maritime" },
  ];
        ...
        {navItems.map((item) => (
          <ListItem key={item.name} disablePadding>
            ...
            >
              ...
              <ListItemText
                primary={item.name === "Maritime" ? "" : item.name}
              />
            </ListItemButton>
          </ListItem>
        ))}
            ...
            <Toolbar disableGutters>
                ...
                {navItems.map((item) => (
                  <Button
                    ...
                    sx={{
                      mx: 1,
                      color: "inherit",
                      borderBottom: isActiveRoute(item.path)
              ...
              <Box
                ...
                sx={{
                  ...
                  marginLeft: 0,
                  width: searchOpen ? { xs: "100%", sm: "auto" } : "auto",
                  ...
                  <InputBase
                    sx={{
                      ...
                      transition: theme.transitions
                        .create("width"),
                      padding: searchOpen ? theme.spacing(1, 1, 1, 0) : 0,
                    }}
                    placeholder="Search…"
